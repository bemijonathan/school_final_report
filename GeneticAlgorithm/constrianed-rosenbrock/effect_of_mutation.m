...
medianBenchmark1Properties.titleText = 'Effect of Random Mutation operator - Himmelblau Cost vs Iterations';
BenchMark(problem, params, medianBenchmark1Properties);
savePlot('effect_of_random_mutation_bench_mark.png')

%% contour plot
params.showContourPlot = true;
out = RunGA(problem, params);
savePlot('effect_of_random_mutation_contour_plot.png')
