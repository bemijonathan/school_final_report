...
medianBenchmark1Properties.titleText = 'Effect of RouletteWheel Selection operator - Himmelblau Cost vs Iterations';
BenchMark(problem, params, medianBenchmark1Properties);
savePlot('effect_of_roulette_wheel_optimal_parameters_line.png')
