...
medianBenchmark1Properties.titleText = 'Effect of (n,y)-strategy Elimination operator - onHimmelblau Cost vs Iterations';
BenchMark(problem, params, medianBenchmark1Properties);
savePlot('effect_of_(n,y)-strategy_optimal_parameters_line.png')
