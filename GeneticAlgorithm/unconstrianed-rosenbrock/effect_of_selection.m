...
medianBenchmark1Properties.titleText = 'Effect of RouletteWheel Selection operator - Rosenbrock Cost vs Iterations';
BenchMark(problem, params, medianBenchmark1Properties);
savePlot('benchmark-b/effect_of_selection/optimal_parameters_line.png')
